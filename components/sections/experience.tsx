...
const EXPERIENCE: TimelineEntry[] = [
  {
    ...
    bullets: [
      ...
      "Shipped high-urgency marketing and legal landing pages under ≤2-day deadlines with pixel-perfect responsive layouts and strict A11y compliance",
      "Engineered an Elasticsearch lookup engine to index essential item metadata, resolving query bottlenecks and cutting server costs and latency",
      "Operated across the multi-year codebase migration from Flow/JS to React and TypeScript, authoring typed interfaces and refactoring legacy Rails controllers",
      "Managed AWS S3 image assets for 100+ hand-crafted segment collections supporting active personalization campaigns",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Designed and ran 50+ concurrent server-side and client-side A/B experiments on a custom in-house testing platform, reducing subscriber churn by 15%",
      "Built a real-time ambient color detection system using raw canvas scripting that adapted the surrounding UI to match a video's dominant tones",
      "Built GDPR-compliant user tracking and telemetry pipelines (Segment, Cookiebot) enabling high-fidelity churn-risk and billing-tier segmentation",
      "Grew from frontend into full-stack, taking ownership of Rails backend work across the product",
    ],
  },
  {
    company: "UAG",
